...
- `GOOGLE_CLIENT_ID`
- `BREVO_API_KEY` (preferred for Railway because it uses HTTPS)
- `SMTP_HOST`, `SMTP_PORT`, `SMTP_USER`, `SMTP_PASS`, `SMTP_FROM`, `SMTP_SECURE` (fallback for environments that allow outbound SMTP)
